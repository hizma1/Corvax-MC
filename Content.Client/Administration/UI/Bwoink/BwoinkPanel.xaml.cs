...
namespace Content.Client.Administration.UI.Bwoink
{
    ...
    public sealed partial class BwoinkPanel : BoxContainer
    {
        ...
        public void ReceiveLine(SharedBwoinkSystem.BwoinkTextMessage message)
        {
            ...
            var body = message.TranslatedText != null
                ? $"[italic]{FormattedMessage.EscapeText(message.Text)}[/italic]"
                : message.Text;
            formatted.AddMarkupOrThrow($"[color=gray]{message.SentAt.ToShortTimeString()}[/color] {body}");
