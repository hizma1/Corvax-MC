...
public sealed partial class NewToJobPopup : FancyWindow
{
    ...
    public void SetJobInfo(string? info,  string name)
    {
        ...
        NewToJobName.SetMessage(FormattedMessage.FromMarkupOrThrow(Loc.GetString("rmc-new-to-job-popup-job-name", ("name", Loc.GetString(name)))));
        NewToJobLabel.SetMessage(FormattedMessage.FromMarkupOrThrow(Loc.GetString(info)));
