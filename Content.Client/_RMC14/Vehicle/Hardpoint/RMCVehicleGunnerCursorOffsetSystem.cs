...
public sealed class RMCVehicleGunnerCursorOffsetSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        if (!TryComp<RMCVehicleGunnerViewUserComponent>(user, out var gunner) ||
    ...
    private void OnGetEyeOffset(Entity<RMCVehicleGunnerViewUserComponent> ent, ref GetEyeOffsetEvent args)
    {
    ...
    private Vector2? OffsetAfterMouse(EntityUid uid, RMCVehicleGunnerViewUserComponent component)
    {
