...
public sealed class VehicleHardpointVendorBui : BoundUserInterface
{
    ...
    public VehicleHardpointVendorBui(EntityUid owner, Enum uiKey) : base(owner, uiKey)
    {
    }
    ...
    protected override void UpdateState(BoundUserInterfaceState state)
    {
        ...
        if (state is not VehicleHardpointVendorBuiState uiState || _window == null)
            return;
    ...
    private void OnVehicleSelected(ItemList.ItemListSelectedEventArgs args)
    {
        ...
        _selectedHardpointId = null;
        SendMessage(new VehicleHardpointVendorSelectMsg(id));
    }
    ...
    private void PrintSelected()
    {
        ...
        SendMessage(new VehicleHardpointVendorPrintMsg(_selectedHardpointId));
    }
}
