...
ent-RMCPatchFreelancer = Freelancer's patch
    .desc = A fire-resistant circular patch featuring a white skull on a vertically split black and blue background. Worn by a skilled mercenary belonging to a freelance mercenary group, representing a life spent navigating the dangerous world of mercenary contracts and loyalty at a price.
