rmc-power-loader-hands-occupied = Чтобы управлять { $mech }, вам нужны обе свободные руки.
rmc-power-loader-cant-grab-full = Клешни { $mech } заняты! Сначала выгрузите содержимое.
rmc-power-loader-too-close = Вы не можете поставить это так близко!
rmc-power-loader-too-far = Слишком далеко!
rmc-power-loader-cant-drop-occupied = Вы не можете поставить { $drop } здесь, путь прегражден!
...
rmc-power-loader-transfer-ammo =
    Вы перемещаете { $rounds } { $rounds ->
        [one] снаряд
        [few] снаряда
       *[other] снарядов
    } в { $ammo }.
rmc-power-loader-wrong-weapon = Это не тот тип боеприпасов!
