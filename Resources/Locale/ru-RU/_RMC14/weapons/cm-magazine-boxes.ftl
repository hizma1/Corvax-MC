...
cm-magazine-box-examine-empty = Выглядит пустой.
cm-magazine-box-examine-almost-empty = Выглядит почти пустой.
cm-magazine-box-examine-half-full = Выглядит полной наполовину.
cm-magazine-box-examine-almost-full = Выглядит почти полной.
cm-magazine-box-examine-magazines =
    В ней { $filled } { $filled ->
        [one] магазин
        [few] магазина
        *[other] магазинов
