...
rmc-xeno-construction-tunnel-examine-not-xeno-empty = [color=purple][italic]Это тёмная бездна...[/italic][/color]
rmc-xeno-construction-tunnel-examine-not-xeno = [color=purple][italic]Это тёмная бездна с парой маленьких... огоньков... будто кто-то наблюдает.[/italic][/color]
...
rmc-xeno-order-construction-limited-structure-designated = Мы намечаем постройку нового { $construct }. (Осталось: { $remainCount }/{ $maxCount })
...
rmc-xeno-construction-repair-structure-no-damage-failure = { CAPITALIZE($struct) } в хорошем состоянии, ремонт не требуется.
...
rmc-xeno-construction-egg-morpher-examine = Внутри: { $cur_paras }/{ $max_paras } паразитов.
rmc-xeno-construction-recovery-node-heal-target = Мы чувствуем, как тёплая аура окутывает нас.
rmc-xeno-construction-recovery-node-heal-other = { CAPITALIZE($target) } начинает сиять, когда его окутывает тёплая аура.
...
rmc-xeno-designer-ui-nodes-count = Узлы дизайна: { $count }/{ $max }
rmc-designnode-human-interact = Вы не понимаете, как взаимодействовать с этим странным узлом.
rmc-designnode-no-plasma = Вам не хватает плазмы, чтобы напитать этот узел.
rmc-xeno-designer-delete-node-none = Здесь нет узла дизайна.
rmc-xeno-designer-delete-node-not-owned = Мы можем удалять только собственные узлы дизайна.
rmc-xeno-designer-use-node-wrong-hive = Этот узел не принадлежит вашему улью!
rmc-xeno-designer-node-needs-weed = Здесь нет сорняков, чтобы создать связь!
rmc-xeno-designer-thicken-none = Здесь нет смоляной структуры для укрепления.
rmc-xeno-designer-thicken-weedbound = Мы не можем укреплять смолу, ограниченную сорняками.
rmc-xeno-designer-thicken-success = Мы укрепляем смолу.
rmc-xeno-designer-greater-surge-cooldown = Нам нужно подождать, прежде чем снова использовать Великий всплеск смолы.
rmc-xeno-designer-greater-surge-none = Поблизости нет узлов дизайна.
rmc-xeno-designer-greater-surge-success = Мы преобразуем { $count } узлов дизайна в толстые смоляные стены.
