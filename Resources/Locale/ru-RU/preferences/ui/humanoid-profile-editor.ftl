...
humanoid-profile-editor-preferred-armor-label = Предпочитаемый бронежилет:
humanoid-profile-editor-enable-playtime-perks = Включить бонусы за игровое время:
humanoid-profile-editor-xeno-prefix = Префикс ксено:
humanoid-profile-editor-xeno-prefix-tooltip = 2 буквы, или 3, если вы наиграли 124 часа на ролях ксено. Установив трёхбуквенный префикс, вы не сможете иметь постфикс.
humanoid-profile-editor-xeno-postfix = Постфикс ксено:
humanoid-profile-editor-xeno-postfix-tooltip = 1 буква, если вы наиграли 24 часа на ролях ксено. 2 буквы или 1 буква и 1 цифра, если вы наиграли 300 часов на ролях ксено. Нельзя иметь постфикс, имея трёхбуквенный префикс.
...
humanoid-profile-editor-preference-unavailable-spawn-as-overflow-button = Получить должность "{ $overflowJob }", если предпочитаемая должность недоступна.
