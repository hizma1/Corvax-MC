...
ent-RMCIDCardCMBDeputySurvivor = серебряный значок представителя БКМ
    .suffix = Выживший
    .desc = Серебряный значок, подтверждающий статус представителя Бюро. Это знак справедливости, авторитета и защиты тех, кто в ней нуждается. Этот значок символизирует приверженность присяге, которая всегда исполняется.
ent-RMCIDCardCMBMarshalSurvivor = золотой значок маршала БКМ
    .suffix = Выживший
    .desc = Заветный золотой значок, подтверждающий, что его обладатель — один из немногих маршалов БКМ, патрулирующих Внешнее кольцо. Это знак справедливости, авторитета и защиты тех, кто не может постоять за себя. Этот значок символизирует приверженность присяге, которая всегда исполняется.
