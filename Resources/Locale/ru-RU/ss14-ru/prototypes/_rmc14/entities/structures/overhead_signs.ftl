ent-RMCOverheadSign = вывеска
    .desc = { "" }
ent-RMCOverheadSignNeon = неонивая вывеска
    .desc = { ent-RMCOverheadSign.desc }
ent-RMCOverheadSignBarCrow = бар «Тонущая ворона»
    .desc = Вывеска бара «Тонущая ворона». Она старая и обветшалая.
